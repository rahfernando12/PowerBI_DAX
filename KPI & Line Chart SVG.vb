...
-------------------------------------------------
-- Text layout (no icon, so start at ContentLeft)
-------------------------------------------------
VAR TextBlockX = ContentLeft        -- left edge for value/label/YoY

VAR KPIVLUY   = ContentTop + 60     -- KPI value
VAR KpiLabelY = ContentTop + 20     -- label
VAR YoYBaseY  = ContentTop + 84    -- YoY group baseline

-------------------------------------------------
-- Line chart layout (fits fully below YoY, within padding)
-------------------------------------------------
VAR ChartTop    = YoYBaseY + 20     -- space under YoY
VAR ChartBottom = ContentBottom
VAR ChartLeft   = ContentLeft       -- align chart with left padding
VAR ChartRight  = ContentRight      -- up to right padding
...
VAR ArrowPointsUp   = "0,5 10,-7 20,5"
VAR ArrowPointsDown = "0,-7 10,5 20,-7"
VAR ArrowPoints =
